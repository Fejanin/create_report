...
sku_svarog = {}
file_svarog = 'data/NV_to_LP.xlsx'
...
file_Sochi = input('Введите названия файла для Нового Времени (отправитель): ')
file_Krim = input('Введите названия файла для Логистического Партнера (получатель): ')
